...
function getCurrentWeek() {
  ...
  function getWeekNumber(date) {
    ...
    const weekNumber = Math.round(((tempDate - firstThursday) / 86400000 + 1) / 7);
      ...
      <div className="action-panel-1">
        <div className="left-panel">
          <div className="date-time-display">
            ...
            <p className="time">
            {selectedWeek && `${new Date(getWeekRange(selectedWeek).start).toLocaleDateString('en-US', { weekday: 'long', month: 'long', day: 'numeric' })} to 
